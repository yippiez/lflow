...
class OutlineStore {
  ...
  // (moves, deletes) are not undoable.
  ...
  // exportText renders the subtree as indented plain text
  ...
  // no-markup invariant. Token vocabulary matches the TUI's tui/database/style.
