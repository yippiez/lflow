...
var nodeTypes = []nodeType{
	...
	// The pluggable node types — nlpcompute, websearch (and the webresult rows a
	// websearch run generates, `internal` so they stay out of this picker) — live
	// in editor/nodes (one Go file per node) and register themselves via
...
// the internal types a plugin generates rather than a user chooses.
