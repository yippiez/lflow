-- This is the canonical lflow schema: the full database shape, applied
-- directly when a fresh database is created. lflow has no migrations —
-- hand-edit this file when the schema changes.
CREATE TABLE system
		(
			key string NOT NULL,
			value text NOT NULL
