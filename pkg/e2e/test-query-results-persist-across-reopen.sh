...
#   "◆ target note · mirror" — proving the result was persisted to the DB and
...
wait_for "◆ target note" 10

# Confirm the mirror child rendered before we save.
...
# Core assertion: the mirror child survived the relaunch.
