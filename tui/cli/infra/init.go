...
import (
	...
	"github.com/lflow/lflow/tui/cli/config"
	"github.com/lflow/lflow/tui/daemon/client"
	"github.com/lflow/lflow/tui/database"
	"github.com/lflow/lflow/tui/runtime"
	"github.com/lflow/lflow/tui/utils"
	"github.com/lflow/lflow/tui/utils/consts"
	"github.com/lflow/lflow/tui/utils/dirs"
...
func getDBPath(paths runtime.Paths, customPath string) string {
...
func resolvePaths() runtime.Paths {
...
func ResolveDBPath() (string, error) {
	...
	customDBPath := ""
	if cf, err := config.Read(runtime.Ctx{Paths: paths}); err == nil {
...
func PrepareDB(db *database.DB, versionTag string) error {
	ctx := runtime.Ctx{Paths: resolvePaths(), Version: versionTag, DB: db}
...
func Init(versionTag string) (*runtime.Ctx, error) {
	ctx := runtime.Ctx{Paths: resolvePaths(), Version: versionTag}
...
func setupCtx(ctx runtime.Ctx) (runtime.Ctx, error) {
...
func initDB(ctx runtime.Ctx) error {
...
func initSystem(ctx runtime.Ctx) error {
...
func initConfigFile(ctx runtime.Ctx) error {
...
func initFiles(ctx runtime.Ctx) error {
	if err := runtime.InitLflowDirs(ctx.Paths); err != nil {
