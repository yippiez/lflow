...
import (
	...
	"github.com/lflow/lflow/tui/daemon"
...
// NewCmd builds the serve command. It does not take a runtime.Ctx: the daemon
...
func NewCmd(versionTag string) *cobra.Command {
	...
	cmd.Flags().StringVar(&httpAddr, "http", "", "also serve the HTTP API + mobile app on this address (e.g. :7420)")
