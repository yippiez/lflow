...
import "github.com/lflow/lflow/tui/database/style"
...
// The token vocabulary (attributes + color names) lives in tui/style, the
...
// The token-list helpers live in tui/style; these thin aliases keep the
