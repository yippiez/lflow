...
# The Temporary Domain is a bottom panel reached by pressing Down past the last main
...
# Step 2: Down enters the Temporary Domain panel (no window swap) — compose appears.
send Down
wait_for "◌"
